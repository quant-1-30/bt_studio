...
class Plot(object):
    ...
    def _plot_main(self, candle):
        ...
        title_div = Div(
            ...
            # text=f"""<h2 ...>Market Feed</h2><p style="color:gray;">ID: {self.cerebro_id} | Strategy: Alpha-1</p>""",
...
if __name__ == "__main__":
    ...
    p_str = "/Users/hengxinliu/startup/bt_studio/tests/logs/log_cerebro_0.parquet"
    # p_str = "/Users/hengxinliu/startup/bt_studio/tests/experiment/logs/log_cerebro_0.parquet"
