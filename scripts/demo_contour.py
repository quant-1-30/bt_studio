#!/usr/bin/env python3
"""Demo script: visualize Ray Tune parameter space with vis.py.

Generates contour, 3D landscape, and collapse dashboard PNGs
from real Ray Tune experiment results.

Usage:
    python scripts/demo_vis.py
    python scripts/demo_vis.py --exp /tmp/ray_results/fsm_hpo_201508
"""
